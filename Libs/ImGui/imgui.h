...
namespace ImGui
{
    ...
    // Widgets: Color EditorLauncher/Picker (tip: the ColorEdit* functions have a little color square that can be left-clicked to open a picker, and right-clicked to open an option menu.)
...
struct ImGuiIO
{
    ...
    // Optional: Notify OS Input Method EditorLauncher of the screen position of your cursor for text input position (e.g. when using Japanese/Chinese IME on Windows)
...
// (Optional) Support for IME (Input Method EditorLauncher) via the io.SetPlatformImeDataFn() function.
